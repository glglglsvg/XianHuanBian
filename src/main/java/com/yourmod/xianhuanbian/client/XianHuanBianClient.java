...
public class XianHuanBianClient implements ClientModInitializer {
    ...
    private static final int[] KEY_CODES = { GLFW.GLFW_KEY_U, GLFW.GLFW_KEY_I, GLFW.GLFW_KEY_O, GLFW.GLFW_KEY_J, GLFW.GLFW_KEY_K, GLFW.GLFW_KEY_L, GLFW.GLFW_KEY_H, GLFW.GLFW_KEY_N, GLFW.GLFW_KEY_M, GLFW.GLFW_KEY_P };
    ...
    public void onInitializeClient() {
        ...
        // 粒子方法...
    private void spawnPlayerRing(...) { /* 不变 */ }
    private void spawnAttackRing(...) { /* 不变 */ }
    private void spawnHorizontalRing(...) { /* 不变 */ }
    ...
    private static class AttributeScreen extends Screen {
        ...
        protected void init() {
            ...
            y += 25;
            vitButton = this.addDrawableChild(ButtonWidget.builder(Text.literal("生命力+ [" + data.getVitality() + "]"), button -> {
                if (data.getAvailablePoints() > 0) {
